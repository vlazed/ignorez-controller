...
-- TODO: Check if sending the entity itself will also send its izc_materials table so we don't have to do all this workaround of
-- writing the material info
...
net.Receive(
    "izc_addMaterialForEntity",
    function()
        addMaterialForEntity()
    end
)

net.Receive(
    "izc_removeMaterialForEntity",
    function()
        removeMaterialForEntity()
    end
)

net.Receive(
    "izc_updateMaterialPropsForEntity",
    function()
        updateMaterialPropsForEntity()
    end
)
